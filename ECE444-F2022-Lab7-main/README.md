...
This repo is a clone of https://github.com/charlesmalafosse/aws-elasticbeanstalk-ml-server
...
* ⚠️ An AWS account. Create an AWS account (it's free) before the meetup. Accounts are usually activated within a few minutes, but the process might take up to 24 hours.
...
💻 **TO-DO:** Create an AWS account to access Elastic Beanstalk
...
💻 **OPTIONAL:** Install fastText on your machine if you want to run locally the python code.

⚠️ ⚠️ To install fastText for Python, do **NOT** use "pip install". This installs an incorrect version for Windows.
...
### ⚠️ DO NOT FORGET TO TERMINATE THE AWS RESOURCES WE CREATED ⚠️
